...
class RecipesListView(ListView):          # class-based view to display a list of recipes
...
class RecipeDetailView(DetailView):      # class-based view to display details of a single recipe
    model = Recipe                        # specify the model to use for this view
